...
df = pd.read_csv(r'C:\Users\acer\Desktop\Programming\ML\Hackathons\Amazon_ML_Challenge_2025\Initial_data_test\extracted_features\processed_data_joined_2_test.csv')
columns_to_drop= ['Unit_Price_Per_Unit_Calculated', 'Unit_Price_Per_Pack_Calculated']

df = df.drop(columns=columns_to_drop)

# 2. Define the directory and file path
directory_name = 'extracted_features'
file_name = 'processed_data_drop_2_test.csv'
